...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Contact Lens Log")
            .toolbar {
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let entry = LensPairEntry(title: newTitle.isEmpty ? "Untitled" : newTitle, note: newNote, value: newValue)
                        if store.add(entry) {
                            showAddSheet = false
                        } else {
                            showAddSheet = false
